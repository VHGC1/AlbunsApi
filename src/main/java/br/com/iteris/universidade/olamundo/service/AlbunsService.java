...
public class AlbunsService {
    ...
    public AlbunsService(final AlbunsRepository repository, AlbunsRepository repository1) {
    ...
    private List<AvaliacaoResponse> recuperaAvaliacao(List<Avaliacao> avaliacoes) {
        return avaliacoes.stream().map(avaliacao -> new AvaliacaoResponse(
    ...
    private String recuperaAvaliacaoMedia(List<Avaliacao> avaliacoes) {
        var resultado = avaliacoes.stream().mapToDouble(Avaliacao::getNota).average();
